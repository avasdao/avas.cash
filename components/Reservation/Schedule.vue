    ...
    <div>
        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-x-16">
            ...
            <ol class="mt-4 divide-y divide-gray-100 text-sm leading-6 lg:col-span-7 xl:col-span-8">
                ...
                <li v-for="token of tokens" :key="token.tokenid" class="relative flex flex-col space-x-6 py-6 xl:static">
                    <div>
                        <img
                ...
                -->
                            <div
                                class="hidden absolute right-0 z-10 mt-2 w-36 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                role="menu"
                    ...
                    <section>
                        <h3>height: {{ token.height }}</h3>
                        <h3 class="truncate">outpoint: {{ token.outpoint }}</h3>
                        <h3 class="truncate">txid: {{ token.txid }}</h3>
                        <h3>tokens: {{ token.tokens }}</h3>
                    </section>
