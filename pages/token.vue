...
useHead({
    title: `Tokenomics — Ava's Cash`,
    meta: [
        { name: 'description', content: `Ava's Cash offers the best tokenomics among its peers.` }
    ],
})
...
<template>
    <main class="max-w-7xl mx-auto py-5">
        ...
        <div class="px-3 sm:px-10 py-5">
            ...
            <h1 class="text-5xl sm:text-6xl font-medium bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">
                $AVAS
            </h1>
